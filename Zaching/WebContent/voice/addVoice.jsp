			...
			<div class="row">
				<div class="form-group">
					...
					<input type='file' name='txtProductFile' size="15"
						...
						readOnly> <img width="200" style='cursor: hand' alt="파일찾기"
					...
					<div class="col-sm-8 text-center" style="margin: 30px 0 30px 0;">
						<input type="text" name="title" placeholder="방 제목을 입력해주세요"
						...
						<option value="1" selected="selected">노래 이어 부르기</option>
						<option value="2">글 읽어주기</option>
						<option value="3">ASMR</option>
						<option value="4">프리토킹</option>
						<option value="5">알림음 만들기</option>
					</select>
					<br/>
					<div class="category1">
